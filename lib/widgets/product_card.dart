                            ...
                            child: Padding(
                                ...
                                child: Column(
                                    ...
                                    children: [
                                        ...
                                        Text(
                                            context.tr('txt_free_delivery_tomorrow'),
                                            style: tt.bodySmall?.copyWith(
                                                fontSize: 11,
                                                color: cs.onSurface
                                            )
                                            ...
                                            child: ElevatedButton(
                                                onPressed: () {
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                        SnackBar(
                                                            content: Text('${context.tr('txt_added')} ${product.title} ${context.tr('txt_to_cart')}'),
