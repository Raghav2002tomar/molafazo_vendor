        ...
        return AnimatedBuilder(
            ...
            builder: (context, _) {
                return Scaffold(
                    ...
                    appBar: AppBar(
                        backgroundColor: Colors.white,
                        title: Text(context.tr('txt_add_product_media'))),
                    body: SingleChildScrollView(
                        ...
                        child: Column(
                            ...
                            children: [
                                ...
                                // ---------- THUMBNAIL ----------
                                label(context.tr('txt_thumbnail')),
                                GestureDetector(
                                ...
                                // ---------- PRODUCT IMAGES ----------
                                label(context.tr('txt_product_images_comp')),
                                OutlinedButton.icon(
                                    icon: const Icon(Icons.add_photo_alternate),
                                    label: Text(context.tr('txt_add_images')),
                                ...
                                // ---------- EXTRA INFO ----------
                                label(context.tr('txt_product_tags')),
                                TextFormField(
                                    controller: controller.tagsController,
                                    decoration: inputDec(context.tr('txt_comma_separation'))
                                ),

                                const SizedBox(height: 16),

                                label(context.tr('txt_weight')),
                                TextFormField(
                                ...
                                label(context.tr('txt_dimensions')),
                                TextFormField(
                                ...
                                label(context.tr('txt_warranty_info')),
                                TextFormField(
                                    controller: controller.warrantyController,
                                    decoration: inputDec(context.tr('txt_warranty_details'))
                                ),

                                const SizedBox(height: 16),

                                label(context.tr('txt_admin_notes')),
                                TextFormField(
                                    controller: controller.seoController,
                                    decoration: inputDec(context.tr('txt_optional'))
                                ),
                                ...
                                FilledButton(
                                    onPressed: () async {
                                        if (controller.thumbnailImage == null ||
                                            ...
                                            ScaffoldMessenger.of(context).showSnackBar(
                                                SnackBar(content: Text(context.tr('txt_images_required')))
                                            );
                                            return;
                                        }
                                    ...
                                    child: Text(context.tr('txt_submit_report'))
                                ),
                                SizedBox(height: 50)
