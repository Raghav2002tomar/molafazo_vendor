...
class _PhoneSignupView extends StatelessWidget {
  ...
  static const int totalSteps = 4; // 5 steps total
                  ...
                  child: ElevatedButton(
                        ...
                        case SignupStep.govtId:
                          if (c.isDocumentVerified) {
                            ...
                            Fluttertoast.showToast(
                              msg: context.tr('txt_please_verify_gov_id'),
                            );
                          }
                          break;
                      }
                    ...
                    child: c.busy
                      ...
                      color: Colors.white,
                        ...
                        : Text(context.tr(_getButtonText(c.step, c.otpSent))),
                  ),
                ),
              ),
          ],
  ...
  String _getButtonText(int step, bool otpSent) {
    switch (step) {
      case SignupStep.phoneOtp:
        return otpSent ? 'txt_verify_otp' : 'txt_send_otp';
      case SignupStep.govtId:
        return 'txt_finish';
      default:
        return 'txt_continue';
        ...
        child: Column(
          ...
          children: [
            ...
            if (c.otpSent) ...[
              const SizedBox(height: 24),
              Text(
                '${context.tr('txt_enter_6_digit_code')} +992 ${widget.phoneCtrl.text}',
                style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                  color: Colors.grey[600],
                ),
              ),
