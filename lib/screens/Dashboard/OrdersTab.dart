...
class _OrderListScreenState extends State<OrderListScreen> {
  ...
  final List<FilterOption> filterOptions = [
    FilterOption('All', 'all_orders', 'show_all_orders', [1, 2, 3, 4]),
    FilterOption('Pending', 'pending_orders', 'new_awaiting_pickup', [1, 2]),
    FilterOption('Completed', 'completed_orders', 'delivered_orders', [3]),
    FilterOption('Cancelled', 'cancelled_orders', 'cancelled_orders_desc', [4]),
  ];
                    ...
                    return Column(
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            context.tr(filter.displayName),
                            style: TextStyle(
                              fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
                            ),
                          ),
                          subtitle: Text(context.tr(filter.description)),
                          onTap: () {
                            setStateBottomSheet(() {
